  ...
  const handleCreate = async () => {
    ...
    try {
      const uploadRes = await axios.post(
        "https://api.cloudinary.com/v1_1/dm1byqohx/image/upload",
        data
      );
      ...
      const res = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/product`, newProduct);
          ...
          <div className="relative z-50 md:w-[600px] w-[370px]  bg-white border-2 p-10 rounded-3xl">
            ...
            <label className="flex gap-2 items-center">
                <input
                  ...
                  className="hidden"
                />
                <button className="btn-primary !rounded-none hover:bg-yellow-200 !bg-yellow-400 pointer-events-none">
                  Choose an Image
                </button>
                {imageSrc && (
                  <div>
