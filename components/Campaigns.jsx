...
const CampaignItem = ()=> {
    return (
        ...
        <div className="relative md:w-40 md:h-40 w-36 h-36 after:content-[''] border-[5px] border-primary rounded-full overflow-hidden">
            <Image src="/images/o1.jpg" alt="" layout="fill" className="hover:scale-105 duration-500" objectFit="cover"/>
        </div>
        <div className="text-white ">
            <Title addClass="text-2xl">Discount Wednesday</Title>
...
const CampaignItem2 =() =>{
    return (
        <div className="bg-secondary flex-1 rounded-md py-5 px-[15px] flex items-center gap-x-4">
            <div className="relative md:w-40 md:h-40 w-36 h-36 after:content-[''] border-[5px] border-primary rounded-full overflow-hidden">
                <Image src="/images/o2.jpg" alt="" layout="fill" className="hover:scale-105 duration-500" objectFit="cover"/>
            </div>
            <div className="text-white ">
                <Title addClass="text-2xl">Discount Wednesday</Title>
                <div className="font-dancing my-1">
