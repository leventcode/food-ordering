...
const MenuItem = ({ product }) => {
  return (
    <div className="bg-secondary rounded-3xl">
        <div className="w-full bg-gray-200 h-[210px] grid place-content-center rounded-bl-[46px] rounded-tr-2xl rounded-tl-2xl">
        <Link href={`/product/${product._id}`}>
          <div className="relative w-36 h-36 z-50 hover:scale-110 duration-500">
